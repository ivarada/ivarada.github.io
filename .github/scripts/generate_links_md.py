...
# Now update index.md between markers (robust: handles whitespace/blank lines)
...
if count == 0:
    raise ValueError("Markers not found in index.md! Make sure both markers are present and correctly spelled.")
